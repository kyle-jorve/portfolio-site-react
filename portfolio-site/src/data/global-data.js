export const globalData = {
	...
	get nav() {
		return [
			...
			},
			{
				...
				icon: '/dist/media/icons/patreon-icon.svg',
				alt: 'Icon for Patreon page',
				cssClass: 'mobileNav__item--patreon',
				showInMobileNav: true,
			},
		];
	},
	...
	get copyright() {
		return `<p>&copy; Copyright 2018-${new Date().getFullYear()} Kyle Jorve. All rights reserved.<br>Website designed and built by Kyle Jorve.</p>`;
	},
};
